...
public class StudentInformatieTest {
    ...
    private static final String url = "http://localhost:8080/Selenium_war_exploded/";
...
//		 Voor mac: 
        System.setProperty("webdriver.chrome.driver", "D:\\Program Files (x86)\\Tools\\chromedriver.exe");
